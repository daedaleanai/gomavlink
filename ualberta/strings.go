...
func (i UalbertaAutopilotMode) String() string {
	i -= 1
	if i >= UalbertaAutopilotMode(len(_UalbertaAutopilotMode_index)-1) {
		return "UalbertaAutopilotMode(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _UalbertaAutopilotMode_name[_UalbertaAutopilotMode_index[i]:_UalbertaAutopilotMode_index[i+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i UalbertaNavMode) String() string {
	i -= 1
	if i >= UalbertaNavMode(len(_UalbertaNavMode_index)-1) {
		return "UalbertaNavMode(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _UalbertaNavMode_name[_UalbertaNavMode_index[i]:_UalbertaNavMode_index[i+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
...
func (i UalbertaPilotMode) String() string {
	i -= 1
	if i >= UalbertaPilotMode(len(_UalbertaPilotMode_index)-1) {
		return "UalbertaPilotMode(" + strconv.FormatInt(int64(i+1), 10) + ")"
	}
	return _UalbertaPilotMode_name[_UalbertaPilotMode_index[i]:_UalbertaPilotMode_index[i+1]]
}
func _() {
	// An "invalid array index" compiler error signifies that the constant values have changed.
	// Re-run the stringer command to generate them again.
