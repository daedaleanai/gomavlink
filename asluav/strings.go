...
func _() {
	...
	_ = x[GSM_MODEM_TYPE_HUAWEI_E3372-2]
}

const (
	_GsmModemType_name_0 = "GSM_MODEM_TYPE_UNKNOWN"
	_GsmModemType_name_1 = "GSM_MODEM_TYPE_HUAWEI_E3372"
)

func (i GsmModemType) String() string {
	switch {
	case i == 0:
		return _GsmModemType_name_0
	case i == 2:
		return _GsmModemType_name_1
	default:
