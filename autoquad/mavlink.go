...
type AutoquadMavlinkDefsVersion uint32

const (
	AQ_MAVLINK_DEFS_VERSION_1 AutoquadMavlinkDefsVersion = 1
)
...
type AutoquadNavStatus uint32

const (
	/* System is initializing */
	AQ_NAV_STATUS_INIT AutoquadNavStatus = 0

	/* System is *armed* and standing by, with no throttle input and no autonomous mode */
	AQ_NAV_STATUS_STANDBY AutoquadNavStatus = 0x00000001

	/* Flying (throttle input detected), assumed under manual control unless other mode bits are set */
	AQ_NAV_STATUS_MANUAL AutoquadNavStatus = 0x00000002

	/* Altitude hold engaged */
	AQ_NAV_STATUS_ALTHOLD AutoquadNavStatus = 0x00000004

	/* Position hold engaged */
	AQ_NAV_STATUS_POSHOLD AutoquadNavStatus = 0x00000008

	/* Externally-guided (eg. GCS) navigation mode */
	AQ_NAV_STATUS_GUIDED AutoquadNavStatus = 0x00000010

	/* Autonomous mission execution mode */
	AQ_NAV_STATUS_MISSION AutoquadNavStatus = 0x00000020

	/* Ready but *not armed* */
	AQ_NAV_STATUS_READY AutoquadNavStatus = 0x00000100

	/* Calibration mode active */
	AQ_NAV_STATUS_CALIBRATING AutoquadNavStatus = 0x00000200

	/* No valid control input (eg. no radio link) */
	AQ_NAV_STATUS_NO_RC AutoquadNavStatus = 0x00001000

	/* Battery is low (stage 1 warning) */
	AQ_NAV_STATUS_FUEL_LOW AutoquadNavStatus = 0x00002000

	/* Battery is depleted (stage 2 warning) */
	AQ_NAV_STATUS_FUEL_CRITICAL AutoquadNavStatus = 0x00004000

	/* Dynamic Velocity Hold is active (PH with proportional manual direction override) */
	AQ_NAV_STATUS_DVH AutoquadNavStatus = 0x01000000

	/* Dynamic Altitude Override is active (AH with proportional manual adjustment) */
	AQ_NAV_STATUS_DAO AutoquadNavStatus = 0x02000000

	/* Craft is at ceiling altitude */
	AQ_NAV_STATUS_CEILING_REACHED AutoquadNavStatus = 0x04000000

	/* Ceiling altitude is set */
	AQ_NAV_STATUS_CEILING AutoquadNavStatus = 0x08000000

	/* Heading-Free dynamic mode active */
	AQ_NAV_STATUS_HF_DYNAMIC AutoquadNavStatus = 0x10000000

	/* Heading-Free locked mode active */
	AQ_NAV_STATUS_HF_LOCKED AutoquadNavStatus = 0x20000000

	/* Automatic Return to Home is active */
	AQ_NAV_STATUS_RTH AutoquadNavStatus = 0x40000000

	/* System is in failsafe recovery mode */
	AQ_NAV_STATUS_FAILSAFE AutoquadNavStatus = 0x80000000
)
...
const (
	/* Orbit a waypoint. */
	MAV_CMD_AQ_NAV_LEG_ORBIT MavCmd = 1

	/* Start/stop AutoQuad telemetry values stream. */
	MAV_CMD_AQ_TELEMETRY MavCmd = 2

	/* Request AutoQuad firmware version number. */
	MAV_CMD_AQ_REQUEST_VERSION MavCmd = 4
...
const (
	...
	MAV_DATA_STREAM_PROPULSION MavDataStream = 1
...
func (m *AqTelemetryF) CRCExtra() uint16 { return 14537 }
...
func (m *AqEscTelemetry) CRCExtra() uint16 { return 45506 }
