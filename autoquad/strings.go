...
func _() {
	...
	// Re-run the stringer command to generate them again.
	var x [1]struct{}
	_ = x[MAV_DATA_STREAM_PROPULSION-1]
...
const (
	_MavDataStream_name_0 = "MAV_DATA_STREAM_ALLMAV_DATA_STREAM_PROPULSIONMAV_DATA_STREAM_EXTENDED_STATUSMAV_DATA_STREAM_RC_CHANNELSMAV_DATA_STREAM_RAW_CONTROLLER"
...
var (
	_MavDataStream_index_0 = [...]uint8{0, 19, 45, 76, 103, 133}
