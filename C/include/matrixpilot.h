...
struct matrixpilot_message {
  ...
  union {
    ...
    struct {
      ...
      uint16_t
          data_address;   /* Address in the flexifunction data, Set to 0xFFFF to
                             use address in target memory */
    ...
    struct {
      uint8_t sue_ROLL_STABILIZATION_AILERONS; /* Serial UDB Extra Roll
                                                  ...
                                                  Enabled */
      uint8_t sue_ROLL_STABILIZATION_RUDDER;   /* Serial UDB Extra Roll
                                                  Stabilization with Rudder
                                                  Enabled */
      uint8_t sue_PITCH_STABILIZATION; /* Serial UDB Extra Pitch Stabilization
                                          Enabled */
      uint8_t sue_YAW_STABILIZATION_RUDDER;  /* Serial UDB Extra Yaw
                                                Stabilization using Rudder
                                                Enabled */
      uint8_t sue_YAW_STABILIZATION_AILERON; /* Serial UDB Extra Yaw
                                                Stabilization using Ailerons
                                                Enabled */
      uint8_t sue_AILERON_NAVIGATION;        /* Serial UDB Extra Navigation with
                                                Ailerons Enabled */
      uint8_t
          sue_RUDDER_NAVIGATION; /* Serial UDB Extra Navigation with Rudder
                                    Enabled */
    ...
    struct {
      float
          sue_YAWKP_AILERON; /* Serial UDB YAWKP_AILERON Gain for Proporional
                                control of navigation */
      float
          sue_YAWKD_AILERON; /* Serial UDB YAWKD_AILERON Gain for Rate control
                                of navigation */
      float
          sue_ROLLKP; /* Serial UDB Extra ROLLKP Gain for Proportional control
                         of roll stabilization */
      float
          sue_ROLLKD; /* Serial UDB Extra ROLLKD Gain for Rate control of roll
                         stabilization */
    } serial_udb_extra_f5;
    ...
    struct {
      ...
      float
          sue_RTL_PITCH_DOWN; /* Serial UDB Extra Return To Landing - Angle to
                                 Pitch Plane Down */
    } serial_udb_extra_f7;
    ...
    struct {
      ...
      float
          sue_ALT_HOLD_THROTTLE_MIN; /* Serial UDB Extra ALT_HOLD_THROTTLE_MIN
                                      */
      float
          sue_ALT_HOLD_THROTTLE_MAX; /* Serial UDB Extra ALT_HOLD_THROTTLE_MAX
                                      */
    ...
    struct {
      ...
      int32_t
          alt_optical_flow; /* Optical flow altitude above ground in meters,
                               expressed as * 1000 (millimeters) */
      int32_t
          alt_range_finder; /* Rangefinder Altitude above ground in meters,
                               expressed as * 1000 (millimeters) */
      int32_t
          alt_extra; /* Extra altitude above ground in meters, expressed as *
                        1000 (millimeters) */
    } altitudes;
