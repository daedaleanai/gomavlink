...
struct slugs_message {
  ...
  union {
    ...
    struct {
      ...
      uint8_t
          sigUsedMask;     /* GPS and GLONASS usage mask (bit 0 GPS_used? bit_4
                              GLONASS_used?) */
    ...
    struct {
      enum CONTROL_SURFACE_FLAG bitfieldPt; /* (uint16_t) Bitfield containing
                                               the passthrough configuration,
                                               see CONTROL_SURFACE_FLAG ENUM. */
      uint8_t target; /* The system setting the commands */
    } ctrl_srfc_pt;
    ...
    struct {
      ...
      int8_t
          moveHome; /* Orders the camera mount to move home. The other fields
    ...
    struct {
      ...
      uint8_t
          r2Type; /* It is the value of reading 2: 0 - Current, 1 - Foreward
    ...
    struct {
      uint32_t
          receiverStatus; /* Status Bitfield. See table 69 page 350 Novatel
                             OEMstar Manual */
